...
var accessToken = /*#__PURE__*/function () {
  ...
  return function accessToken(_x, _x2) {
...
var refreshToken = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var token, data, userData, _accessToken;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          token = req.cookies.refreshToken;
          data = _jsonwebtoken["default"].verify(token, process.env.REFRESH_SECRET);
          _context2.next = 5;
          return _User["default"].findOne({
            _id: data.id
          });
...
var postLogin = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var _req$body, email, password, user, ok, _accessToken2, _refreshToken;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 8:
          ...
          return _context4.abrupt("return", res.json({
            ok: "error",
            error: "이메일/패스워드가 다릅니다."
          }));
        case 11:
          try {
            // accessToken 발급
            _accessToken2 = _jsonwebtoken["default"].sign({
              id: user._id
            }, process.env.ACCESS_SECRET, {
              expiresIn: "1m"
            }); // refreshToekn 발급
            ...
            res.cookie("accessToken", _accessToken2, {
              secure: false,
              httpOnly: true
            });
