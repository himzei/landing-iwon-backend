...
exports.postWrite = exports.getList = void 0;
var _Consulting = _interopRequireDefault(require("../models/Consulting.js"));
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _Consulting["default"].find({}).sort({
            createdAt: -1
          });
        case 3:
          consulting = _context.sent;
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _req$body = req.body, name = _req$body.name, email = _req$body.email, tel = _req$body.tel, category = _req$body.category, message = _req$body.message, type = _req$body.type;
          if (name === "" || email === "" || tel === "") {
            res.json({
              ok: "false",
